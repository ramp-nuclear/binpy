...
import rebinpy
from rebinpy.integrator import ConstantIntegrator


def rebin(xarr, x1, integrator=ConstantIntegrator(), *, axis=0, prepend=None, append=None):
    dims = list(xarr.dims)
    ...
    y = rebinpy.rebin(xarr.values, x0, x1, integrator=integrator, axis=naxis)
